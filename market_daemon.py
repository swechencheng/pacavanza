...
MODULE = "pacavanza.data_sources.avanza_market"

logging.basicConfig(
    filename=os.path.join(LOG_DIR, "market_daemon.log"),
    level=logging.INFO,
...
SCHEDULES = [
    ("mini-l-omx-ava-468", "Europe/Stockholm", dtime(9, 0), dtime(17, 30)),
    ("mini-s-omx-ava-1575", "Europe/Stockholm", dtime(9, 0), dtime(17, 30)),
    ("mini-l-sp500-ava-270", "America/New_York", dtime(9, 30), dtime(16, 0)),
    ("mini-s-sp500-ava-330", "America/New_York", dtime(9, 30), dtime(16, 0)),
]
...
def scheduler_loop():
    while True:
        try:
            for symbol, tz, start_t, end_t in SCHEDULES:
